...
<p align="center">
  ...
  <img src="Bakım Öncesi ve Sonrası Kesinti Sayısı Değişimi (OG).png" width="85%" title="OG (Orta Gerilim) Görünümü" />
</p>
...
> **🔒 Veri Gizliliği Notu:** Şirket gizlilik politikaları gereği, tüm orijinal veri setleri projeden kalıcı olarak silinmiştir. Bu depo yalnızca veri modelleme, DAX formülleri ve görsel tasarım yeteneklerini sergileyen Power BI Şablon (`.pbit`) dosyasını içermektedir.

### 🎯 Öne Çıkan Metrikler ve Görseller
Dashboard, ham şebeke verilerini eyleme dönüştürülebilir iş zekasına (BI) çevirmek için şu temel görsellere odaklanır:
